...
const Navbar: React.FC<NavbarProps> = ({setFilters, maxRevenue, loggedInUser, logout, navigate }) => {
    return (
        <nav className="fixed w-full top-0 left-0 z-50 p-4 bg-transparent bg-[radial-gradient(transparent_1px,var(--token-f32baa44-90b8-42a5-8bca-ffba9d95b23a,#171717)_1px)] bg-[size:4px_4px] backdrop-blur-[3px] opacity-100 mask-[linear-gradient(rgb(0,0,0)_60%,rgba(0,0,0,0)_100%)]">
